...
class Artist
{
    ...
    #[ORM\Column(type: Types::SIMPLE_ARRAY, nullable: true, enumType: StyleEnum::class)]
    ...
    public function setStyle(?array $styles): static
    {
        $this->style = array_map(fn($style) => StyleEnum::from($style), $styles);
